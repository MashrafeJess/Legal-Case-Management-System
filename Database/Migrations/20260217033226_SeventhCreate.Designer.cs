...
namespace Database.Migrations
{
    ...
    [Migration("20260217033226_SeventhCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Database.Model.Case", b =>
                {
                    ...
                    b.Property<bool>("IsConsultationFeePaid")
            ...
            modelBuilder.Entity("Database.Model.MailLog", b =>
                {
                    b.Property<int>("MailLogId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("MailLogId"));
            ...
            modelBuilder.Entity("Database.Model.MailLog", b =>
                {
                    b.HasOne("Database.Model.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Database.Model.User", "Sender")
                        .WithMany()
